...
if (manifest.name !== 'Claudish') throw new Error('manifest name must be Claudish');
...
if (!css.includes('--accent-h:')) throw new Error('theme.css must define the Claudish accent system');
...
console.log(`Claudish ${manifest.version} passed CSS parsing, manifest, asset, and network checks.`);
