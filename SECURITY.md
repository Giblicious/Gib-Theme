...
Claudish is a static stylesheet. It does not require accounts, credentials, telemetry, analytics, or runtime network access. Release validation rejects remote HTTP and HTTPS assets in `theme.css`.
